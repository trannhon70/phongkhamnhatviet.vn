// const local = 'http://localhost/_nhatvietnew/phongkhamnhatviet.vn';
const local = 'https://phongkhamnhatviet.vn';
...
function onClickCreatePhone() {
    ...
    if (sdt.trim() !== '') {
        if (formatPhoneNumber(sdt)) {
            ...
            toastr("Số điện thoại không hợp lệ!", 'error');
        }

    } else {
        toastr("Số điện thoại không được bỏ trống", 'error');
