...
if (Session::get('role') === '1') {
    ...
    if (isset($_GET['delete'])) {
        $id = $_GET['delete'];
        // Xử lý xóa tin tức và thông báo sau khi xóa thành công
            ...
            ?>
                    <tr>
                        ...
                        <td style="width: 200px;">
                            <select style="text-transform: capitalize;" name="id_khoa" class="form-select" onchange="getOptionValue(this, '<?php echo $result['ma_benh']; ?>')">
...
<script>
    ...
    async function getOptionValue(select, ma_benh) {
