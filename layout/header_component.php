<header id="header_pc" class="header">
    <div class="header__top">
        <div class="header__top-left">
            ...
            <!-- <amp-img class="header__top-left-logo" src="<?php echo $local ?>/images/logo/logo2.webp" height="70px" width="250px" alt="..."></amp-img> -->
        </div>
        ...
        <nav class="header__bottom-nav">
            <ul class="header__bottom-nav-ul">
                ...
                <li class="header__bottom-nav-ul-li header__bottom-border">
                    <a class="" href="<?php echo $local ?>">giới thiệu</a>
                </li>
