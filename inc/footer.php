         ...
         <div class="footer__mobile-container">
             <a href="tel:+02877767777" class="footer__mobile-container-left">
                 ...
                 <div class="footer__mobile-container-left-icon">
                     <img width="65px" height="auto" src="<?php echo $local ?>/images/logo_mobile/icon_phone_red.png" alt="...">
                 </div>
...
<div class="footer_list_icon">
     <div>
        <a class="footer_icon_happy" href="<?php echo $local ?>" target="_blank">
            <amp-img src="<?php echo $local ?>/images/logo_mobile/icon_happy.gif" height="50px" width="50px" alt="..."></amp-img>
        </a>
    </div>
     <div style="margin-top:10px">
        <a class="footer_icon_zalo" href="<?php echo $local ?>" target="_blank">
            <amp-img src="<?php echo $local ?>/images/logo_mobile/icon_zalo.png" height="50px" width="50px" alt="..."></amp-img>
            <div class="ping_zalo"></div>
        </a>
    </div>
     <div style="margin-top:10px">
        <a class="footer_icon_mess" href="<?php echo $local ?>" target="_blank">
            <amp-img style="margin-left:3px" src="<?php echo $local ?>/images/logo_mobile/icon_message.webp" height="45px" width="45px" alt="..."></amp-img>
            <div class="ping"></div>
